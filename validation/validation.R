...
source('../model.R')
source('../shinyapp/prediction.R')

# Load validation data
articles1 <- fread("articles1.csv", encoding = "UTF-8")[,10]
articles2 <- fread("articles2.csv", encoding = "UTF-8")[,10]
articles3 <- fread("articles3.csv", encoding = "UTF-8")[,10]
